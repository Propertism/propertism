#!/usr/bin/env python
"""
Add demo content in English, Tamil, and Hindi for owner review
...
from content.models import CompanyInfo, Service, CoreValue, Statistic
...
def add_company_info():
    ...
    if CompanyInfo.objects.exists():
        ...
        print("Updating existing company info...")
    else:
        company = CompanyInfo()
        print("Creating new company info...")
...
def add_services():
    ...
    for service_data in services_data:
        ...
        print(f"✅ Service added: {service_data['title_en']}")
...
def add_statistics():
    ...
    for stat_data in stats_data:
        ...
        print(f"✅ Statistic added: {stat_data['value']} {stat_data['label']}")


def main():
    """Main function to add all demo content"""
    print("=" * 60)
    print("ADDING DEMO CONTENT IN ENGLISH, TAMIL, AND HINDI")
    print("=" * 60)
    ...
    try:
        ...
        print("\n" + "=" * 60)
        print("✅ ALL DEMO CONTENT ADDED SUCCESSFULLY!")
        print("=" * 60)
        print("\nYou can now view the website in:")
        print("- English: https://propertism-demo.onrender.com/en/")
        print("- Tamil:   https://propertism-demo.onrender.com/ta/")
        print("- Hindi:   https://propertism-demo.onrender.com/hi/")
